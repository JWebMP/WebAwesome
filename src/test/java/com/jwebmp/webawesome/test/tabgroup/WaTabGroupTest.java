...
public class WaTabGroupTest
{
    ...
    public void testRenderBasicTabGroupHtml()
    {
        ...
        assertTrue(s.contains("<wa-tab-panel id=\"tab1\" name=\"tab1\""));
        assertTrue(s.contains("<wa-tab-panel id=\"tab2\" name=\"tab2\""));
        assertTrue(s.contains("<wa-tab-panel id=\"tab3\" name=\"tab3\""));
