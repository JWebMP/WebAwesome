...
public class FormatDate<J extends FormatDate<J>> extends DivSimple<J>
{
    ...
    public J setWeekdayFormat(WaWeekdayFormat weekdayFormat)
    {
        this.weekdayFormat = weekdayFormat;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setEraFormat(WaWeekdayFormat eraFormat)
    {
        this.eraFormat = eraFormat;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setYear(WaTwoDigitFormat year)
    {
        this.year = year;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setMonth(WaMonthFormat month)
    {
        this.month = month;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setDay(WaTwoDigitFormat day)
    {
        this.day = day;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setHour(WaTwoDigitFormat hour)
    {
        this.hour = hour;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setMinute(WaTwoDigitFormat minute)
    {
        this.minute = minute;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setSecond(WaTwoDigitFormat second)
    {
        this.second = second;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    public J setTimezoneNameFormat(WaTimezoneNameFormat timezoneNameFormat)
    {
        this.timezoneNameFormat = timezoneNameFormat;
        return (J) this;
    }    @SuppressWarnings("unchecked")
    ...
    public J setHourFormat(WaHourFormat hourFormat)
    {
