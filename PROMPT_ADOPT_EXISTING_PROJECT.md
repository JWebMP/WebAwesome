...
- Repository URL / local path: https://github.com/JWebMP/WebAwesome.git
- Org and project name: JWebMP / Web Awesome
- Short description: The JWebMP Wrapper that uses an angular typescript implemention for Web Awesome, called angular-awesome (NPM)
- Angular-awesome API docs live in `docs/index.html`
